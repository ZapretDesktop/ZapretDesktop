...
Рекомендуется всегда использовать последнюю стабильную версию из [релизов](https://github.com/OWNER/ZapretDesktop/releases) (подставьте актуальный owner/repo).
